...
public static class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
        ...
        routeGroup.MapPost("/register", async Task<Results<Ok, ValidationProblem,
            ...
            ([FromBody] Dto.Auth.RegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp, [FromServices] TokenListService tokenListService) =>
        {
            ...
            appUser.Avatar = registration.Avatar;
